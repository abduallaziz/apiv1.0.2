...
export class TenantsRepository {
  ...
  private static readonly PROFILE_COLUMNS =
    'id, name, business_type, activity, status, trial_ends_at, created_at, currency_code, currency_symbol, tax_rate, customer_capture_enabled, name_field_enabled, logo_url, tax_number, invoice_footer, printer_settings, notification_preferences';
