...
export class AdvancedAnalyticsService {
  constructor(
    private readonly advancedAnalyticsRepo: AdvancedAnalyticsRepository,
  ) {}
  ...
  turnover(
    ...
    return this.advancedAnalyticsRepo.turnoverReport(
      tenantId,
      dateFrom,
      dateTo,
      warehouseId,
  ...
  abcAnalysis(
    ...
    return this.advancedAnalyticsRepo.abcAnalysis(
      tenantId,
      dateFrom,
      dateTo,
      warehouseId,
  ...
  deadStock(tenantId: string, lookbackDays?: number, warehouseId?: string) {
    return this.advancedAnalyticsRepo.deadStockReport(
      tenantId,
      lookbackDays,
      warehouseId,
    );
  ...
  slowMoving(
    ...
    return this.advancedAnalyticsRepo.slowMovingReport(
      tenantId,
      lookbackDays,
      maxUnitsSold,
      warehouseId,
  ...
  stockAccuracy(
    ...
    return this.advancedAnalyticsRepo.stockAccuracyReport(
      tenantId,
      dateFrom,
      dateTo,
      warehouseId,
