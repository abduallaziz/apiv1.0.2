...
add('cashier', ['invoice.create.own','invoice.view.own','invoice.view','invoice.create','expense.request','expenses.view','shift.open','shift.close','shift.view.own','items.view','customers.view','customers.manage','inventory.view','inventory.reserve','attendance.checkin']);
add('worker', ['invoice.view.own','invoice.view','shift.view.own','items.view','inventory.view','attendance.checkin']);
