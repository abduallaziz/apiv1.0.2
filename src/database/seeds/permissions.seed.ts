...
add('inventory_clerk', ['items.view','inventory.view','inventory.adjust','inventory.transfer','inventory.count','inventory.reserve','purchasing.view','purchasing.manage','purchasing.receive','attendance.checkin']);
