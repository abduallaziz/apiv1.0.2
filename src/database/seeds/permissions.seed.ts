...
const permissions = [
  ...
  { name: 'inventory.transfer.approve', resource: 'inventory', action: 'transfer.approve', description: 'Approve draft transfers before dispatch' },
  ...
  { name: 'inventory.fulfill', resource: 'inventory', action: 'fulfill', description: 'Pick, pack and ship warehouse shipments' },
  ...
  { name: 'purchasing.approve', resource: 'purchasing', action: 'approve', description: '(legacy, superseded by purchasing.po.approve) Approve purchase orders' },
  { name: 'purchasing.po.approve', resource: 'purchasing', action: 'po.approve', description: 'Approve purchase orders' },
  { name: 'purchasing.po.reject', resource: 'purchasing', action: 'po.reject', description: 'Reject purchase orders' },
  { name: 'purchasing.pr.approve', resource: 'purchasing', action: 'pr.approve', description: 'Approve purchase requests' },
  { name: 'purchasing.pr.reject', resource: 'purchasing', action: 'pr.reject', description: 'Reject purchase requests' },
  { name: 'purchasing.receive', resource: 'purchasing', action: 'receive', description: 'Post goods receipts' },

  // HR
  { name: 'attendance.checkin', resource: 'attendance', action: 'checkin', description: 'Check in/out and view own attendance history' },
  { name: 'attendance.view.all', resource: 'attendance', action: 'view', description: 'View all employees attendance' },
  { name: 'hr.manage', resource: 'hr', action: 'manage', description: 'Manage work schedules and commission rates' },

  // Tables & dine-in (restaurants/cafes)
  { name: 'tables.manage', resource: 'tables', action: 'manage', description: 'Manage tables, dine-in orders, reservations and waitlist' },
  { name: 'kitchen.manage', resource: 'kitchen', action: 'manage', description: 'View and update kitchen order item status (KDS)' },

  // Coupons
  { name: 'coupons.manage', resource: 'coupons', action: 'manage', description: 'Create and manage discount coupons' },

  // Gift Cards
  { name: 'gift_cards.manage', resource: 'gift_cards', action: 'manage', description: 'Issue and manage gift cards' },

  // Order note presets
  { name: 'note_presets.manage', resource: 'note_presets', action: 'manage', description: 'Create and manage preset order notes' },
];
...
add('inventory_clerk', ['items.view','inventory.view','inventory.adjust','inventory.transfer','inventory.count','inventory.reserve','inventory.fulfill','purchasing.view','purchasing.manage','purchasing.receive','attendance.checkin']);
add('cashier', ['invoice.create.own','invoice.view.own','invoice.view','invoice.create','expense.request','expenses.view','shift.open','shift.close','shift.view.own','items.view','customers.view','customers.manage','inventory.view','inventory.reserve','attendance.checkin','tables.manage','kitchen.manage']);
add('worker', ['invoice.view.own','invoice.view','shift.view.own','items.view','inventory.view','attendance.checkin','kitchen.manage']);
