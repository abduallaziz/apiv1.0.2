-- =============================================================================
-- 033. ADD LOCATION CODE TO ENRICHED STOCK LEVELS LISTING
-- The Inventory Levels UI needs location_code (e.g. "A01") alongside
-- location_name to render grouped/expandable location breakdowns
-- (e.g. "A01 - Shelf A"). Re-creates 025's function with the added column.
-- =============================================================================

DROP FUNCTION IF EXISTS fn_inventory_stock_levels_enriched(UUID, UUID, UUID, UUID, UUID, UUID, UUID, TEXT);

CREATE FUNCTION fn_inventory_stock_levels_enriched(
  p_tenant_id    UUID,
