...
### Execution Gate (Mandatory) — نص المستخدم الحرفي المُعتمَد

بعد كل Architectural Audit وDatabase Design وBusiness Rules وState Machine وMigration Matrix:
- **لا افتراض اعتماد أبدًا.**
- **لا إنشاء Migrations.**
- **لا إنشاء Backend Code.**
- **لا توليد DDL.**
- **لا تعديل أي ملف بالمشروع.**

الانتظار حتى يرد المستخدم صراحة بـ:

> **"Approved – Proceed with Implementation"**

فقط بعد هذي الموافقة الحرفية يبدأ التنفيذ. لو الموافقة غير صريحة، **البقاء بوضع التصميم/المراجعة بغض النظر عن كون كل الملاحظات بدت مُغلَقة**.
