...
- [ ] COGS (تكلفة المنتج) — أصبح قابلًا للبناء الآن بعد حل الاكتشاف الحرج أعلاه (البيانات المصدرية `stock_movements.movement_type='sale'` تُسجَّل الآن فعليًا) — لم يُبنَ بعد كـendpoint مُجمَّع، لكن لم يعد مسدودًا
